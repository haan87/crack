    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://fb.me/reputsu404')
                time.sleep(2)
                menu()
...
def mini():
    ...
    try:
        ...
        print logo
        print 40 * '\x1b[1;97m\xe2\x95\x90'
        print '\x1b[1;91m[ INFO ] Akun target harus berteman dengan dengan anda dulu !'
        try:
